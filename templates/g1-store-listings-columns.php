...
if ( $wpsl_settings['radius_dropdown'] || $wpsl_settings['results_dropdown'] ) {
	...
	if ( $wpsl_settings['radius_dropdown'] ) {
		...
		$output .= "\t\t\t\t\t" . '<label for="wpsl-radius-dropdown">' . esc_html( $wpsl->i18n->get_translation( 'radius_label', __( 'Search radius', 'mcp-abilities-store-locator' ) ) ) . '</label>' . "\r\n";
	...
	if ( $wpsl_settings['results_dropdown'] ) {
		...
		$output .= "\t\t\t\t\t" . '<label for="wpsl-results-dropdown">' . esc_html( $wpsl->i18n->get_translation( 'results_label', __( 'Results', 'mcp-abilities-store-locator' ) ) ) . '</label>' . "\r\n";
